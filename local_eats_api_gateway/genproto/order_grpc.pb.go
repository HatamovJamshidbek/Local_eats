...
type OrderServiceClient interface {
	...
	UpdateNutritionInfo(ctx context.Context, in *UpdateNutritionInfoRequest, opts ...grpc.CallOption) (*Dish, error)
	ActivityUser(ctx context.Context, in *GetUserActivityRequest, opts ...grpc.CallOption) (*GetUserActivityResponse, error)
	KitchenStatistic(ctx context.Context, in *GetKitchenStatisticRequest, opts ...grpc.CallOption) (*KitchenStatisticsResponse, error)
}
...
func (c *orderServiceClient) UpdateNutritionInfo(ctx context.Context, in *UpdateNutritionInfoRequest, opts ...grpc.CallOption) (*Dish, error) {
	out := new(Dish)
	err := c.cc.Invoke(ctx, "/protos.OrderService/UpdateNutritionInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderServiceClient) ActivityUser(ctx context.Context, in *GetUserActivityRequest, opts ...grpc.CallOption) (*GetUserActivityResponse, error) {
	out := new(GetUserActivityResponse)
	err := c.cc.Invoke(ctx, "/protos.OrderService/ActivityUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderServiceClient) KitchenStatistic(ctx context.Context, in *GetKitchenStatisticRequest, opts ...grpc.CallOption) (*KitchenStatisticsResponse, error) {
	out := new(KitchenStatisticsResponse)
	err := c.cc.Invoke(ctx, "/protos.OrderService/KitchenStatistic", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	UpdateNutritionInfo(context.Context, *UpdateNutritionInfoRequest) (*Dish, error)
	ActivityUser(context.Context, *GetUserActivityRequest) (*GetUserActivityResponse, error)
	KitchenStatistic(context.Context, *GetKitchenStatisticRequest) (*KitchenStatisticsResponse, error)
...
func (UnimplementedOrderServiceServer) UpdateNutritionInfo(context.Context, *UpdateNutritionInfoRequest) (*Dish, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateNutritionInfo not implemented")
}
func (UnimplementedOrderServiceServer) ActivityUser(context.Context, *GetUserActivityRequest) (*GetUserActivityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ActivityUser not implemented")
}
func (UnimplementedOrderServiceServer) KitchenStatistic(context.Context, *GetKitchenStatisticRequest) (*KitchenStatisticsResponse, error) {
...
func _OrderService_UpdateNutritionInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateNutritionInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).UpdateNutritionInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.OrderService/UpdateNutritionInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).UpdateNutritionInfo(ctx, req.(*UpdateNutritionInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OrderService_ActivityUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserActivityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).ActivityUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.OrderService/ActivityUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ActivityUser(ctx, req.(*GetUserActivityRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OrderService_KitchenStatistic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetKitchenStatisticRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).KitchenStatistic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.OrderService/KitchenStatistic",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).KitchenStatistic(ctx, req.(*GetKitchenStatisticRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrderService_UpdateNutritionInfo_Handler,
		},
		{
			MethodName: "ActivityUser",
			Handler:    _OrderService_ActivityUser_Handler,
		},
		{
			MethodName: "KitchenStatistic",
			Handler:    _OrderService_KitchenStatistic_Handler,
		},
	},
