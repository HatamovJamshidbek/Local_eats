...
type UserServiceClient interface {
	...
	UpdatePassword(ctx context.Context, in *UpdatePasswordRequest, opts ...grpc.CallOption) (*Void, error)
...
func (c *userServiceClient) UpdatePassword(ctx context.Context, in *UpdatePasswordRequest, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
...
type UserServiceServer interface {
	...
	UpdatePassword(context.Context, *UpdatePasswordRequest) (*Void, error)
...
func (UnimplementedUserServiceServer) UpdatePassword(context.Context, *UpdatePasswordRequest) (*Void, error) {
